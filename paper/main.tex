...
14 qualifying papers. The sparsity of this set is itself a primary finding: the
evidence base for bipedal humanoid clinical research is narrow and concentrated.
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.7\columnwidth]{figures/regulatory_pathways.pdf}
