...
fingertip sensor density exceeding 1,000 sensing elements\xl{这里的 1,000 sensing elements 是非常具体的硬件阈值，必须补 citation；最好找 tactile sensor / GelSight / high-resolution fingertip sensor 的权威论文来支撑这个数量级。}, and teleoperation
...
thorax, 140~N and 210~N/cm$^2$\xl{这些 65 N、110 N/cm2、140 N、210 N/cm2 是标准里的具体数值，必须有直接 citation；建议把 ISO/TS 15066 的 citation 贴到这句话后面，或者确认这些数值完全来自该标准。}. The GentleHumanoid framework demonstrates a
...
robotic action in a care setting\xl{这个 claim 不能简单找一篇文献证明“没有 liability framework”；应当补 healthcare AI liability、autonomous robotics liability、medical device/product liability 文献，用来支撑现有法律框架在 autonomous clinical AI/robotic action 上存在 accountability gap。}. This legal ambiguity deters adoption regardless
...
21~CFR~\S{}201(h) and EU MDR Article~2(1)\xl{这里直接引用 FDA 和 EU MDR 的法规条文定义，必须补官方 citation；法规条文不能只写名称，最好引用 FDA medical device definition 和 EU MDR Article 2(1) 原文或官方网页。}. This creates a hard gap: the system
...
regulatory entry route. No 510(k) predicate exists\xl{这里是很强的监管路径判断，必须补 citation 或证据说明；建议引用 FDA De Novo guidance / FDA product classification database，并解释为什么没有合适的 510(k) predicate。}. A De~Novo submission requires
...
Class~IIb or~III\xl{这里涉及 EU MDR Annex VIII 的分类规则，必须补官方 EU MDR citation；Class IIa、IIb、III 的判断最好对应具体 classification rule，而不是只写作者判断。}. EU AI Act Regulation 2024/1689 additionally classifies any
...
2027\xl{这里的 high-risk AI system 和 August 2026 / August 2027 生效时间是非常具体的法律时间点，必须补 EU AI Act 官方文本或权威法律分析；日期尤其不能裸写。}. Any EU clinical humanoid market entry must satisfy both MDR and AI Act
...
\xl{这一节写得有点少。跟其他段落的长度不匹配，建议扩展一下，尤其是The AI validation gap extends to deployment readiness}
