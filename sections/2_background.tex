...
\textbf{User acceptance and form factor.} Patients in clinical settings
are frequently in positions of physical vulnerability and
dependence~\cite{gallagher2008dignity,fuseini2022dignity}.
Contextual evidence on form factor comes from research on the HRP-4C platform,
which demonstrated that gait naturalness and facial expression generation
systematically affected observer ratings of approachability and social
presence~\cite{cao2025humanoid}.

This evidence supports, but does not yet conclusively prove, the
