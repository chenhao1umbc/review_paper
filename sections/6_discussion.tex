...
\xl{这里的平台比较涉及 open SDK、lowest cost、prototype-only、highest haptic sensing specification、closed ecosystem 等产品规格和商业属性，建议补充权威来源，例如公司官方技术文档、产品白皮书、公开规格表，或前文已经引用过的对应平台论文；如果前文已经建立这些事实，这里可以改成引用前文表格或章节，避免重复堆 citation。}
...
\end{figure}
\xl{这里的 FDA De Novo、21 CFR 513(f)(2)、predicate/510(k)、EU MDR、EU AI Act 生效时间和 MDR Article 62 都是具体监管事实，必须有官方法规或权威 guidance 支撑；如果 Section 5 已经加过这些 citation，这里建议引用 Section~\ref{sec:challenges} 或对应监管小节/表格，不需要重复堆 citation。}
