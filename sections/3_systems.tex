...
\begin{table*}[t]
  ...
  \caption{Humanoid Platform Capability Comparison (March 2026).}
  \label{tab:platforms}
  \resizebox{\linewidth}{!}{%
  \begin{tabular}{@{}llrlllll@{}}
    ...
    Unitree G1~\cite{unitree2024g1}       & Commercial & 132 & 23--43         & N/A        & Yes (VLA, open)       & Yes     & Research prototype\textsuperscript{$\dagger$}~\cite{atar2025humanoids,cho2026humanoid} \\
    ...
    \bottomrule
    \multicolumn{8}{@{}l@{}}{\textsuperscript{$\dagger$}Research prototype only, not clinical deployment.} \\
    \multicolumn{8}{@{}l@{}}{\textsuperscript{*}Not bipedal under this paper's scope definition; included as deployment benchmark.} \\
  \end{tabular}%
  }
\end{table*}
...
\begin{table*}[t]
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{2.60cm}
                  ...
                  >{\raggedright\arraybackslash}p{6.10cm}
                  >{\raggedleft\arraybackslash}p{1.10cm}@{}}
    \toprule
    ...
    \bottomrule
    \multicolumn{7}{@{}l@{}}{\textbf{Stars}: approximate GitHub star counts recorded in March 2026.} \\
    \multicolumn{7}{@{}l@{}}{\textbf{Med.\ Rel.} $\mid$ medical relevance, author-assessed.} \\
    \multicolumn{7}{@{}l@{}}{\textbf{H} = direct support for candidate clinical platforms; \textbf{M} = transferable general-purpose capability; \textbf{L} = infrastructure or simulation support only.} \\
    % \multicolumn{7}{@{}l@{}}{None of the listed repositories provides clinical-specific safety validation or medical workflow integration.} \\
  \end{tabular}%
  }
\end{table*}
