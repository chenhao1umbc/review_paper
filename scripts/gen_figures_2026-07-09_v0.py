...
Run with: python scripts/gen_figures.py
Output: figures/trl_readiness.pdf
        figures/evidence_landscape.pdf
        figures/tech_timeline.pdf
        figures/regulatory_pathways.pdf
        figures/capability_gap.pdf
"""
...
def gen_evidence_landscape():
    """
    Evidence distribution by domain x year.
